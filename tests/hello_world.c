...
int ei_main(int argc, char** argv)
{
	...
	ei_anchor_t	button_anchor	= ei_anc_northwest;
        ...
        ei_size_t       window_size2     = {100,100};
        char*           window_title2    = "Test";
        ...
        ei_point_t	window_position2	 = {50, 50};
	...
	ei_app_create(&screen_size, EI_FALSE); 
        ...
        ei_button_configure(button, NULL, &button_color, &button_border_width, NULL, &relief, &button_title, NULL, &text_color, NULL,  NULL, NULL, NULL, &button_callback, NULL);
